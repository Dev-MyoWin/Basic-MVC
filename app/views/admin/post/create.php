 ...
 <div class="container-fluid my-5">
     <div class="container">
         <div class="col-md-8 offset-md-2">
                <div class="card p-5">
                        <h3 class="text-center text-info">Register your information</h3>
                    <form action="<?php echo URLROOT."post/create"?>" method="POST" enctype="multipart/form-data">

                        <div class="form-group">
                            <label for="cat_id">Create A Post</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?php echo !empty($data['title_err']) ? 'is-invalid' : ''; ?> "name="desc" id="desc" rows="3"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control <?php echo !empty($data['title_err']) ? 'is-invalid' : ''; ?> " name="content" id="content" rows="3"></textarea>
